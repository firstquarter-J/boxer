...
ANTHROPIC_AUTH_TOKEN_COMMAND = os.getenv("ANTHROPIC_AUTH_TOKEN_COMMAND", "")
ANTHROPIC_AUTH_TOKEN_COMMAND_TIMEOUT_SEC = int(
    os.getenv("ANTHROPIC_AUTH_TOKEN_COMMAND_TIMEOUT_SEC") or "5"
)
...
# REQUEST_AUDIT_*는 기존 공개 설치의 입력 호환으로만 읽는다. 새 설정값과
# module API는 REQUEST_LOG_* 이름 하나만 노출한다.
