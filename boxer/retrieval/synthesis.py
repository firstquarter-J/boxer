...
def _build_retrieval_synthesis_input(
    ...
    *,
    ...
    normalized_extra_rules = (extra_rules or "").rstrip()
    ...
    if thread_context:
        return (
            ...
            f"{evidence_text}\n\n"
            "Output rules:\n"
            "1) Answer in the user's language when it is clear from the question; otherwise answer in English.\n"
            "2) Use only evidence.\n"
...
def _synthesize_retrieval_answer(
    ...
    *,
    ...
    extra_rules: str = "",
    evidence_transform: Callable[[Any], Any] | None = None,
    ...
    if evidence_transform is not None:
        payload = evidence_transform(payload)
